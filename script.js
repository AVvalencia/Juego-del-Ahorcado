let palabras = [
    'CHATA', 'HELADO', 'LLUVIA', 'ZAPATO', 'GEMELOS', 'CERVEZA', 'WHISKI', 'NARANJA', 'PICANTE', 'NEGRO', 'PATO', 'AVION', 'TOMATE', 'OJO', 'CIELO',
    'YATE', 'JUGO', 'CSS', 'MAR', 'TSUNAMI', 'PIZZA', 'BURRITO', 'SOLEADO', 'LUZ', 'VIENTO', 'TORRE', 'CAOS', 'GATO', 'KOALA', 'DRAGON', 'LEON',
    'CARRO', 'PATINES', 'ESTUFA', 'JAVASCRIPT', 'ALURA', 'PIEZAS', 'AJEDREZ', 'YAUTIA', 'NARUTO', 'ESTUCHE', 'CINTURA', 'CABELLO',
    'SOL', 'HTML', 'BUENO', 'NEUTRO', 'GENIAL', 'OSCURO', 'TIEMPO', 'HIELO', 'QUIETO', 'PINTURA', 'IGUALES', 'BONITO', 'FEO', 'CELULAR', 'MARATON',
    'MASCOTA', 'BUHO', 'ONE', 'HILO', 'ARO', 'TIERNO', 'CABALLO', 'PELUCA', 'TIJERAS', 'ALGODON', 'CALVO', 'REPTIL', 'HOYO', 'CASA', 'FRESA',
